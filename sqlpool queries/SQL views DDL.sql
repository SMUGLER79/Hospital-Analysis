...
CREATE VIEW bed_turnover_rate AS
SELECT 
    p.gender,
...
CREATE VIEW avg_treatment_duration AS
SELECT 
    d.department,
    p.gender,
...
CREATE VIEW patient_volume_trend AS
SELECT 
    f.admission_date,
    p.gender,
...
CREATE VIEW department_inflow AS
SELECT 
    d.department,
    p.gender,
...
CREATE VIEW overstay_patients AS
SELECT 
    d.department,
    p.gender,
